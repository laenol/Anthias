...
Go to one of the links above and click the _Join_ button, then select either _Ethernet only_ or _Wifi + Ethernet_ for Network options.
You can either click the _Flash_ button to open balenaEthcher (make sure that it's installed) or download the image file and flash it using your preferred imager.
...
You can find the latest release [here](https://github.com/laenol/Anthias/releases/latest). From there, you can download the disk image that you need and flash it to your SD card.
...
Starting [v0.19.0](https://github.com/laenol/Anthias/releases/tag/v0.19.0), devices installed using this option will be
...
>   - As a [GitHub issue](https://github.com/laenol/Anthias/issues)
>   - In [GitHub Discussions](https://github.com/laenol/Anthias/discussions)
...
[releases](https://github.com/laenol/Anthias/releases) page.
